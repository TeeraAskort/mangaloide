...
const unfollowComic = async (
  ...
  if (index === -1) {
    return res.status(400).json({ message: "You're not following the comic" });
  }
  ...
  user.comicsFollowing.splice(index, 1);
